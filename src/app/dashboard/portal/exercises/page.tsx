...
export default function PortalExercisesPage() {
    ...
    const fetchUserPatientId = async () => {
        ...
        const { data: patient } = await supabase
            .from('patients')
            .select('id')
            .eq('auth_user_id', user.user.id) // Updated to use auth_user_id which is more reliable
            .single();
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-600 text-sm mt-1">
                    Tu plan de recuperación personalizado
                </p>
            </div>
            ...
            {prescriptions.length === 0 ? (
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                        Tu fisioterapeuta asignará ejercicios a tu plan pronto.
                    </p>
                </div>
            ) : (
